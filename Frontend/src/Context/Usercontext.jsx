...
export const UserProvider = ({ children }) => {
    ...
    return (
        <Usercontext.Provider value={{ OrderHistory,loading, handlePaymentSelect, ShowAddress, selectedAddress, setSelectedAddress, SelectPayment, setSelectPayement, PlaceOrder, AddressSubmit, AddressChange, AddressForm, Setdata, newdata, GetCartProducts, RemoveCartproduct, Addproduct, DecreaseQty, FetchCart, navigate, AddCartProduct, getprofile, Userlogout, HandleChange, FormSubmit, UserForm, islogin, Setislogin, OpenLogin, SetOpenlogin, SetShowProfile, ShowProfile, }}>
            {children}
